...
{   
    public function run()
    {
        DB::table('products')->insert([
            ...
            [
                'name' => 'Cactus Dancing Doll Talking Toy Mainan Kaktus Goyang Menari Bicara',
                'category_id' => '17',
                'description' => '<ul><li>Bahan: produk ini terbuat dari kapas pp kapas mewah yang lembut dan mewah, terasa nyaman.</li><li>Desain kreatif: mainan ini didesain dengan bentuk kaktus yang lucu dan desain kreatifnya yang unik tampak hebat. -dancing: mainan ini bisa menghibur tubuh Anda, yang bisa memberi Anda suasana hati yang bahagia.</li><li>Hadiah sempurna: mainan ini menarik untuk menari dan bernyanyi, hadiah ulang tahun / natal terbaik untuk anak-anak, teman dan keluarga.</li><li>Portabilitas: produk kecil, ringan dan mudah dibawa.</li></ul>',
                'price' => '57000',
                'photo' => 'Cactus Dancing Doll Talking Toy Mainan Kaktus Goyang Menari Bicara.png'
            ],
            [
            ...
            [
                'name' => 'Celana Chino Pendek Slim Fit',
                'category_id' => '6',
                'description' => '<p>Deskripsi Produk :</p><ul><li>Model pria pada foto, tinggi 182cm berat 79kg pakai SIZE 33</li><li>Celana selalu ready stock, tersedia ukuran mulai dari size 27 - 38, bisa langsung di order</li><li>Tabel ukuran setiap size ada di gambar (geser foto sampai akhir)<br>&nbsp;</li></ul><p>Celana Chino pendek untuk pria dengan model pinggang karet, sehingga nyaman digunakan untuk sehari hari dan beraktifitas dan juga tidak perlu takut apabila pinggang tidak pas, karena bisa melar / stretch</p><ul><li>Cara mudah menentukan ukuran celana adalah dengan menyamakan dengan size celana yang biasa dipakai.</li><li>Bahan Katun Twill Stretch / melar (Bahan sejuk dan nyaman dipakai, tidak mudah kusut, berbulu dan mudah dicuci tidak luntur)</li><li>Terdapat kantong 2 kantong pada bagian belakang celana dan 2 kantong samping</li></ul>',
                'price' => '149000',
                'photo' => 'Celana Chino Pendek Slim Fit.jpg'
            ],
            [
            ...
            [
                'name' => 'Celana Pendek Unisex Erigo Nylon Short Pants Sandre Bark - 28',
                'category_id' => '6',
                'description' => '<p>Erigo Short pants Nylon saat ini merupakan salah satu lini pakaian terbaik dan berkualitas tinggi di antara Local Brand Indonesia. Short pants Nylon are undoubtedly an essential style! Selain serba guna karena modis, celana ini juga merupakan must-have item bagi para pria. Erigo Chino Short di design dengan warna indah dengan kain pilihan yang membuatmu nyaman sepanjang hari. Memiliki live-button, resleting, belt loop, dan 4 saku simpel pada bagian pinggul.<br><br>Untuk Model Pria: Tinggi 185-186 cm, Berat 75 kg, Menggunakan Ukuran XL<br>Untuk Model Wanita: Tinggi 168-170 cm, Berat 55 kg, Menggunakan Ukuran M<br><br>Bahan: Katun<br><br>Toleransi setiap size 1-1½cm<br>*Untuk Detail size tersedia di Display Produk</p>',
                'price' => '128000',
                'photo' => 'Celana Pendek Unisex Erigo Nylon Short Pants Sandre Bark - 28.jpg'
            ],
            [
                'name' => 'Celana Pendek Unisex Erigo Nylon Pants Parisa Mahogany - 28',
                'category_id' => '6',
                'description' => '<p>Erigo Short pants Nylon saat ini merupakan salah satu lini pakaian terbaik dan berkualitas tinggi di antara Local Brand Indonesia. Short pants Nylon are undoubtedly an essential style! Selain serba guna karena modis, celana ini juga merupakan must-have item bagi para pria. Erigo Chino Short di design dengan warna indah dengan kain pilihan yang membuatmu nyaman sepanjang hari. Memiliki live-button, resleting, belt loop, dan 4 saku simpel pada bagian pinggul.<br><br>Untuk Model Pria: Tinggi 185-186 cm, Berat 75 kg, Menggunakan Ukuran XL<br><br>Untuk Model Wanita: Tinggi 168-170 cm, Berat 55 kg, Menggunakan Ukuran M<br><br>Bahan: Katun<br>Toleransi setiap size 1-1½cm<br><br>*Untuk Detail size tersedia di Display Produk</p>',
                'price' => '128000',
                'photo' => 'Celana Pendek Unisex Erigo Nylon Pants Parisa Mahogany - 28.jpg'
            ],
            [
                'name' => 'Celana Unisex Erigo Denim Short Pants Lonie Light Blue - 28',
                'category_id' => '6',
                'description' => '<p>Denim Short pants Lonie Light BlueAda berbagai jenis short pants, mulai dari yang dikenakan sebagai busana formal, pakaian pantai hingga untuk olahraga. Dengan mengusung corak mode \'Jorts\', Philo Light Black dibuat dari bahan denim pilihan. Dilengkapi 4 saku: 2 di sisi kanan dan kiri serta 2 di bagian belakang, Geddes Medium Blue sangat klop saat dipakai semi formal maupun ketika santai berkumpul bersama teman sejawat.<br><br>Untuk Model Pria: Tinggi 185-186 cm, Berat 75 kg, Menggunakan Ukuran XL<br>Untuk Model Wanita: Tinggi 168-170 cm, Berat 55 kg, Menggunakan Ukuran M<br><br>Bahan: Denim<br><br>Detail Ukuran: Tersedia di display produk<br><br>*Diukur secara manual, toleransi ukuran ± 1-2 cm</p>',
                'price' => '128000',
                'photo' => 'Celana Unisex Erigo Denim Short Pants Lonie Light Blue - 28.jpg'
            ],
            [
                'name' => 'Celana Unisex Erigo Denim Short Pants Onondaga Medium Blue - 32',
                'category_id' => '6',
                'description' => '<p>Ada berbagai jenis short pants, mulai dari yang dikenakan sebagai busana formal, pakaian pantai hingga untuk olahraga. Dengan mengusung corak mode \'Jorts\', Uxio Medium Black dibuat dari bahan denim pilihan. Dilengkapi 4 saku: 2 di sisi kanan dan kiri serta 2 di bagian belakang, Onondaga Medium Blue sangat klop saat dipakai semi formal maupun ketika santai berkumpul bersama teman sejawat.<br><br>Untuk Model Pria: Tinggi 185-186 cm, Berat 75 kg, Menggunakan Ukuran XL<br>Untuk Model Wanita: Tinggi 168-170 cm, Berat 55 kg, Menggunakan Ukuran M<br><br>Bahan: Denim<br><br>Detail Ukuran: Tersedia di display produk</p><p>*Diukur secara manual, toleransi ukuran ± 1-2 cm.</p>',
                'price' => '128000',
                'photo' => 'Celana Unisex Erigo Denim Short Pants Onondaga Medium Blue - 32.jpg'
            ],
            [
            ...
            [
                'name' => "Levi's Daphne Scrunchie Blouse Persimmon (A1906-0002) - S",
                'category_id' => '7',
            ...
            [
                'name' => 'Kaos Polo Wanita Hush Puppies Ardith 3 Mint - S',
                'category_id' => '7',
                'description' => '<p>- Polo shirt bernuansa cerah dengan aksen playful embroidery<br>- Warna<br>- Detail kerah<br>- Unlined<br>- Regular fit<br>- Kancing depan<br>- Material katun kombinasi tidak transparan, ringan dan tidak stretch<br><br>Ukuran produk<br>Lingkar Dada x Lingkar Pinggang x Panjang:<br>- S (91cm x 91cm x 62cm)<br>- M (95cm x 95cm x 64cm)<br>- L (99cm x 99cm x 65cm)<br>- XL (103cm x 103cm x 66cm)<br>- XXL (107cm x 107cm x 67cm)</p>',
                'price' => '199000',
                'photo' => 'Kaos Polo Wanita Hush Puppies Ardith 3 Mint - S.jpg'
            ],
            [
                'name' => 'Kaos Polo Wanita Hush Puppies Reline White',
                'category_id' => '7',
                'description' => '<p>- Polo shirt desain timeless basic dengan detail stripes trim<br>- Warna<br>- Detail kerah<br>- Unlined<br>- Regular fit<br>- Kancing depan<br>- Material katun kombinasi tidak transparan, ringan, dan agak stretch</p>',
                'price' => '229000',
                'photo' => 'Kaos Polo Wanita Hush Puppies Reline White.jpg'
            ],
            [
